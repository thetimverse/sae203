...
<div class="admin">
    <h1>Modifier une catégorie de POP!</h1>
    <br>
    ...
    <?php
        ...
        $id=$_GET['num'];
        $co=connexionBD();
        $type=getCategorie($co, $id);
        var_dump($type);
        deconnexionBD($co);
    ?>

    <div class="form-gestion">
    <form action="table2_update_valide.php" method="post">
    <input type="hidden" name="num" value="<?= $id; ?>" />

            Média d'origine : <input type="text" name="media" value="<?php echo $type['type_media']; ?>" required /><br />
            Édition : <input type="text" name="edition" value="<?php echo $type['type_edition']; ?>" required /><br />
