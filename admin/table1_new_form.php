...
<div class="admin">
    ...
    <form action="table1_new_valide.php" method="post" enctype="multipart/form-data">
            ...
            Numéro (#000) : <input type="text" name="numero" required /><br />
            ...
            Matériau : <input type="text" name="materiau" required /><br />
            Taille (en cm) : <select name="taille" required>
                <option value="choisir">--Choisissez une valeur--</option>
                <option value="10">10</option>
                <option value="25">25</option>
            </select><br />
            Lien d'achat : <input type="text" name="lien" required /><br />
	        Photo : <input type="file" class="input-long" name="photo" required /><br />
	        Média d'origine et édition : <select class="input-long" name="media" required>
                <?php
                    require '../lib_crud.inc.php';
                    $co=connexionBD();
                    afficherMediaOptions($co);
                    deconnexionBD($co);
                ?>
	        </select><br /> 
